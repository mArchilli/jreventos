...
import {
    getMainWhatsAppHref,
    getProductsWhatsAppHref,
    getSectionWhatsAppDisplay,
    getSectionWhatsAppHref,
    isProductsSectionComponent,
} from '@/utils/whatsapp';
...
export default function Footer() {
    ...
    const { events = [] } = props;
    const isProductsPage = isProductsSectionComponent(component);
    const whatsappDisplay = getSectionWhatsAppDisplay(component);
    const whatsappHref = getSectionWhatsAppHref(component, {
        mainMessage: 'Hola, quiero comunicarme con JR Eventos para consultar por un evento.',
        productsMessage: 'Hola! Le hago una consulta por los productos de la página.',
    });
    ...
    const handleSubmit = (e) => {
        ...
        const text = isProductsPage
            ? [
                'Hola! Le hago una consulta por los productos de la página.',
                `Mi nombre es ${name}.`,
                message,
            ].filter(Boolean).join('\n')
            : [
        ...
        window.open(
            isProductsPage ? getProductsWhatsAppHref(text) : getMainWhatsAppHref(text),
            '_blank',
            'noopener,noreferrer'
        );
    };
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-16 py-10 md:py-14 border-t border-white/5">
                    ...
                    <div>
                        ...
                        <div className="space-y-6">
                            <a href={whatsappHref} target="_blank" rel="noopener noreferrer" className="flex items-start gap-4 group">
                                ...
                                <div>
                                    ...
                                    <span className="text-white/70 group-hover:text-white transition-colors text-sm">{whatsappDisplay}</span>
                                </div>
                            </a>
