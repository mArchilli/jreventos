                ...
                <main className="relative z-10 mx-auto w-full max-w-6xl px-4 py-12">
                    ...
                    <div className="mb-8 flex items-center justify-between">
                        <div>
                            ...
                            <h1 className="font-black uppercase text-white" style={{ fontSize: 'clamp(28px,5vw,56px)' }}>Artistas</h1>
                    ...
                    {artists.length === 0 ? (
                        <div className="flex flex-col items-center justify-center rounded-2xl bg-white/5 border border-white/10 py-20">
                            ...
                            <p className="text-white/40 text-sm">No hay artistas cargados aún.</p>
                        </div>
                    ) : filteredArtists.length === 0 ? (
                        <div className="flex flex-col items-center justify-center rounded-2xl bg-white/5 border border-white/10 py-20">
                            <p className="text-white/40 text-sm">No se encontraron artistas para la búsqueda.</p>
                        </div>
                    ) : (
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                            {filteredArtists.map(artist => {
                                ...
                                return (
                                    <div key={artist.id} className="relative group rounded-2xl bg-white/5 border border-white/10 overflow-hidden transition duration-200 hover:border-yellow-300/30 hover:-translate-y-0.5">
                                        ...
                                        <div className="p-5">
                                            <h3 className="text-lg font-black uppercase text-white truncate">{artist.name}</h3>
                                            <div
            ...
            {deleteTarget && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <div className="relative w-full max-w-sm rounded-2xl bg-zinc-900 border border-white/10 shadow-2xl p-8">
                        ...
                        <h3 className="text-center text-lg font-black uppercase text-white">¿Eliminar artista?</h3>
                        <p className="mt-2 text-center text-sm text-white/50">
                            Estás por eliminar <span className="font-semibold text-yellow-300">{deleteTarget.name}</span>.
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <div className="relative w-full max-w-2xl rounded-2xl bg-zinc-900 border border-white/10 shadow-2xl p-8 max-h-[90vh] overflow-y-auto">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            {/* Name */}
                            <div>
                                <label className="block text-xs font-semibold uppercase tracking-wide text-white/50 mb-1">Nombre</label>
                            ...
                            {editing && editing.images?.length > 0 && (
                                <div>
                                    <label className="block text-xs font-semibold uppercase tracking-wide text-white/50 mb-2">
                                        Imágenes actuales
                                        <span className="ml-1 text-white/30 normal-case font-normal">(tildá la principal · ✕ para eliminar)</span>
                                    </label>
                            ...
                            <div>
                                <label className="block text-xs font-semibold uppercase tracking-wide text-white/50 mb-2">
                                    ...
                                    {!editing && <span className="ml-1 text-white/30 normal-case font-normal">(la primera será la principal por defecto)</span>}
                                </label>
